...
{
    /// <summary>
    /// A packet sent to set a shimmered item's information.
    /// </summary>
    [StructLayout(LayoutKind.Explicit, Size = 30)]
    public struct ShimmerItemInfo : IPacket
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the item is shimmered.
        /// </summary>
        [field: FieldOffset(24)] public bool IsShimmered { get; set; }

        /// <summary>
        /// Gets or sets a value indicating how long the item is shimmered.
        /// </summary>
        [field: FieldOffset(25)] public float ShimmerTime { get; set; }

        PacketId IPacket.Id => PacketId.ShimmerItemInfo;

        int IPacket.ReadBody(Span<byte> span, PacketContext context) => span.Read(ref _bytes, 29);

        int IPacket.WriteBody(Span<byte> span, PacketContext context) => span.Write(ref _bytes, 29);
    }
}
